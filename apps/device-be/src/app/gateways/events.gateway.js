...
var EventsGateway = function () {
    ...
    var EventsGateway = _classThis = /** @class */ (function () {
        function EventsGateway_1(tasksService) {
            var _this = this;
            ...
            this.tasksService = tasksService;
            tasksService.addJob('atmosphere', new cron_1.CronJob(schedule_1.CronExpression.EVERY_SECOND, function () {
                var value = getRandomNumber(70, 75);
                _this.server.sockets.emit('atmosphere:data', {
                    temperature: value,
                    humidity: 35,
                    scale: 'C',
                });
        ...
        EventsGateway_1.prototype.handleConnection = function (client) {
            ...
            this.logger.log("".concat(client.id, " connected"));
            this.tasksService.startJob('atmosphere');
        };
        EventsGateway_1.prototype.handleDisconnect = function (client) {
            var args = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                args[_i - 1] = arguments[_i];
            }
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.logger.log("".concat(client.id, " disconnected"));
                            return [4 /*yield*/, this.server.sockets.fetchSockets()];
                        case 1:
                            noClients = !(_a.sent()).length;
                            if (noClients) {
